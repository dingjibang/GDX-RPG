...
export default class FileListItems extends React.Component {
	...
	componentWillMount() {
		this.reader = require("../scripts/FileType/" + this.props.type);
		this.load();
	}
	...
	static text(file){
		return (file.prefix ? ("[" + file.prefix.text + "]") : "") + file.label + "  " + file.fileName;
	}
	...
	render() {
		...
		filtedFiles = filtedFiles.sort(FileListItems.sort)
