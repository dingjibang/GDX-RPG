...
public class SpriteCache implements Disposable {
	static private final float[] tempVertices = new float[5 * 6];
	...
	private final ArrayList<Texture> textures = new ArrayList<Texture>(8);
	private final ArrayList<Integer> counts = new ArrayList<Integer>(8);
