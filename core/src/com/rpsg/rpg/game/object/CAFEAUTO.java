...
//			hideMSG();
//			$(new BaseScriptExecutor() {public void init() {
//				RPG.ctrl.cg.push(black=(Image) $.add(Res.getNP(Setting.UI_BASE_IMG)).setSize(GameUtil.screen_width, GameUtil.screen_height).setColor(0,0,0,0).getItem()).addAction(Actions.color(new Color(0,0,0,1),1f));
//			}});
//			wait(60);
