 ...
 */
public class V8ExecutorEx extends Thread {
     ...
     */
    public V8ExecutorEx(final String script, final boolean longRunning, final String messageHandler) {
        this.script = script;
     ...
     * @param script The script to execute on this executor.
     */
    public V8ExecutorEx(final String script) {
