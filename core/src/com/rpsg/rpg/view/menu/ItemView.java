...
//		sb.begin();
//		Res.font.draw(sb, item.name, 22, Color.WHITE, 455, 134, 1000);
//		Res.font.draw(sb, item.illustration, 18, Color.DARK_GRAY, 459, 100, 490);
//		scuse.draw(sb);
...
//				render.end();
//				Res.font.draw(sb, h.prop.get("hp")+"/"+h.prop.get("maxhp"), 16, blue, 572+176/2-Res.font.getTextWidth(h.prop.get("hp")+"/"+h.prop.get("maxhp"), 20,-7)/2, 158, 400,-5,0);
//				Res.font.draw(sb, h.prop.get("mp")+"/"+h.prop.get("maxmp"), 16, blue, 572+176/2-Res.font.getTextWidth(h.prop.get("mp")+"/"+h.prop.get("maxmp"), 20,-7)/2, 121, 400,-5,0);
//				Res.font.draw(sb, "正常", 18, blue, 563+176/2-Res.font.getTextWidth("正常", 18)/2, 196, 400);
//				Res.font.draw(sb, h.toString(), 18, Color.WHITE, 515, 227, 200);
//				if(drawp){
