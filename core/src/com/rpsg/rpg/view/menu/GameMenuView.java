...
//				return false;
		...
		stage.addActor(pane);
		stage.addActor(Res.get(Setting.GAME_RES_IMAGE_MENU_GLOBAL + "tip_escape.png").position(40 + (offset += 120), 520).disableTouch());
		stage.addActor(Res.get(Setting.GAME_RES_IMAGE_MENU_GLOBAL + "tip_select.png").position(40 + (offset += 120), 520).disableTouch());
		stage.addActor(Res.get(Setting.GAME_RES_IMAGE_MENU_GLOBAL+"tip_z.png").position(40 + (offset += 120), 520).disableTouch());
 	}
