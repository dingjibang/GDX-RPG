...
move(renko, -1);
pause(40);
setBalloon(renko,BalloonType.汗);
showMSG(MsgType.莲子);
say("不……不会吧！","莲子？");
showMSG(MsgType.梅莉);
say("骗你的","梅莉？");
...
faceTo(RPGObject.FACE_D);
faceTo(renko,RPGObject.FACE_U);
MoveController.offsetActor.addAction(Actions.scaleTo(0.9,0.9,1,Interpolation.pow4Out));
...
say("这，这不一样！我想想……","莲子");
hideMSG();
setBalloon(renko,BalloonType.沉默);
pause(80);
setBalloon(renko,BalloonType.灵感);
showMSG(MsgType.莲子);
